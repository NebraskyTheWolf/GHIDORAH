module.exports = {
    ...
    'get /users/isBlacklisted/:id/:guild': {'function': 'UserController.isBlacklisted', protected: false},
    ...
    'get /user/verify/:code/:guild/fetchByCode': {'function': 'VerifyController.fetchByCode', protected: false},
    'get /user/verify/:id/:guild/update': {'function': 'VerifyController.update', protected: false},
