...
module.exports = {
    ...
    async execute(interaction, interactionUser, guild) {
        ...
        const platform = interaction.fields[4].value.toLowerCase();

        if (platform === undefined || platform !== 'pc' || platform !== 'x1' || platform !== 'ps4') {
            ...
            await mozambiqueClient.search({
                ...
                embed.addField("Kills", `${result.total.damage}`, true);
